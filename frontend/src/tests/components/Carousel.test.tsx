...
function generateImages() {
  const foo: CarouselImage = {
    id: 0,
    image: "/sampleReports/tCleverly_Midfielder.png",
    alt: "sampleReport1",
  };
  const bar: CarouselImage = {
    id: 1,
    image: "/sampleReports/comparison_R.Bennett_B.Wilmot.png",
    alt: "sampleReport2",
  };
  const bar2: CarouselImage = {
    id: 2,
    image: "/sampleReports/Millwal_ J._Cooper.png",
    alt: "sampleReport3",
  };
